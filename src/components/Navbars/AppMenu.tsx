...
const AppMenu = () => {
	...
	// Ensure you import these at the top:
	...
	const mobileHeaderLinkUrl = [
		...
		},
		{
			...
			icon: totalOrderedItems > 0 ? RiInboxArchiveLine : RiCpuLine,
			onClick:
				totalOrderedItems > 0
		...
		},
		{
			...
			// RiUser6Line for a clean operator profile
			// RiFingerprintLine for the "Hardware Security" login feel
			icon: isLoggedIn ? RiUser6Line : RiFingerprintLine,
			onClick: isLoggedIn
